...
import { 
  ...
  Users, Clock, Zap, BarChart3, Radio, UploadCloud, Lock, CheckCircle, AlertCircle, Sparkles, ScanLine, ChevronDown, Info, CheckCircle2
} from 'lucide-react';
...
const ITDepartment: React.FC<DepartmentProps> = ({ dept, navigate }) => {
  const containerRef = useRef<HTMLDivElement>(null);

...
export const BrushFlashLight: React.FC<EventPageProps> = ({ isDark, onBack }) => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-stone-50 text-stone-900 overflow-x-hidden selection:bg-[#ff007f] selection:text-white font-sans transition-colors duration-500">
      ...
      <div className="fixed top-0 left-0 w-full z-[110] px-8 py-10 md:px-12 md:py-12 flex justify-between items-center pointer-events-none">
        ...
        >
          <div className="p-3 border-2 border-[#ff007f]/30 group-hover:border-[#ff007f] rounded-full transition-all bg-white/60 backdrop-blur-xl shadow-[0_0_20px_rgba(255,0,127,0.3)]">

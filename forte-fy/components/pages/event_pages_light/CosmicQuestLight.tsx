    ...
    <div ref={containerRef} className="min-h-screen bg-[#f8faff] text-slate-900 selection:bg-indigo-600 selection:text-white overflow-x-hidden font-sans">
         ...
         <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-16 mb-32 relative">
               ...
               <div className="lg:w-2/3 space-y-6">
                  {[
                     ...
                     <div key={i} className="reveal-up-l group p-8 rounded-3xl bg-white border border-slate-200 hover:border-indigo-300 hover:shadow-lg transition-all duration-500 flex items-start gap-6 cursor-pointer">
            ...
            <div className="flex flex-col lg:flex-row-reverse gap-16 mb-32 relative">
               ...
               <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="reveal-up-l group p-10 rounded-3xl bg-gradient-to-br from-white to-slate-50 border border-slate-200 hover:border-indigo-300 hover:shadow-xl transition-all duration-500 relative overflow-hidden cursor-pointer">
                  ...
                  <div className="reveal-up-l group p-10 rounded-3xl bg-gradient-to-br from-white to-slate-50 border border-slate-200 hover:border-fuchsia-300 hover:shadow-xl transition-all duration-500 relative overflow-hidden cursor-pointer">
            ...
            {/* Event Segments */}
            <div className="reveal-up-l mb-32">
               <div className="flex flex-col items-center mb-16 text-center">
                  <h3 className="text-4xl md:text-6xl font-heading font-black uppercase tracking-tight text-slate-900 mb-4">Event <span className="text-amber-500">Segments</span></h3>
                  <p className="text-slate-600 font-light max-w-2xl">Three distinct challenges designed to test different facets of astronomical knowledge and creativity.</p>
               </div>
               ...
               <div className="space-y-6">
                  {[
                     ...
                     <div key={i} className="group relative p-8 md:p-12 rounded-3xl bg-white border border-slate-200 hover:shadow-xl transition-all duration-500 overflow-hidden cursor-pointer flex flex-col md:flex-row gap-8 items-center">
                        <div className="absolute -right-10 -top-10 text-[150px] font-black text-slate-50 group-hover:text-slate-100 transition-colors duration-500 pointer-events-none font-heading leading-none">
                           {seg.num}
                        </div>
                        <div className="w-full md:w-1/3 relative z-10">
                           <div className="text-6xl font-black mb-4 font-heading" style={{ color: seg.color }}>{seg.num}.</div>
                           <h4 className="text-3xl font-bold text-slate-900 uppercase mb-4">{seg.title}</h4>
                           <p className="text-slate-600 font-light text-sm leading-relaxed">{seg.desc}</p>
                        </div>
                        <div className="w-full md:w-2/3 relative z-10 flex flex-col md:flex-row gap-8 md:items-center justify-between border-t md:border-t-0 md:border-l border-slate-200 pt-8 md:pt-0 md:pl-8">
                           <ul className="space-y-3">
                              {seg.points.map((pt, j) => (
                                 <li key={j} className="flex items-center gap-3 text-slate-700 font-light">
                                    <span className="w-2 h-2 rounded-full" style={{ backgroundColor: seg.color }} />
                                    {pt}
                                 </li>
                              ))}
                           </ul>
                           <div className={`max-w-xs p-4 rounded-2xl ${seg.bg} border ${seg.border}`}>
                              <p className="text-xs text-slate-600 italic leading-relaxed">{seg.note}</p>
                           </div>
                        </div>
                     </div>
                  ))}
            ...
            {/* Recognition & Rewards */}
            <div className="reveal-up-l p-8 md:p-16 rounded-[3rem] bg-gradient-to-br from-slate-900 to-indigo-950 border border-slate-800 shadow-2xl text-center relative overflow-hidden group">
               <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-10 pointer-events-none" />
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-amber-400/5 rounded-full blur-[100px] group-hover:bg-amber-400/10 transition-colors duration-1000 pointer-events-none" />
               
               <div className="relative z-10">
                  <Award size={64} className="text-amber-400 mx-auto mb-8 drop-shadow-[0_0_20px_rgba(251,191,36,0.6)] animate-pulse" />
                  <h3 className="text-4xl md:text-6xl font-heading font-black uppercase tracking-tight text-white mb-6">Recognition & <span className="text-amber-400">Rewards</span></h3>
                  <p className="text-indigo-100 font-light mb-16 max-w-2xl mx-auto text-lg">Forte-FY strongly believes in recognising excellence. All dedicated participants and ambassadors receive official certification and recognition.</p>
                  
                  <div className="flex flex-col md:flex-row justify-center items-end gap-8 md:gap-12 h-auto md:h-80">
                     {/* 2nd Prize */}
                     <div className="w-full md:w-64 p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-indigo-400/50 hover:-translate-y-4 transition-all duration-500 flex flex-col items-center group/card cursor-pointer">
                        <div className="w-20 h-20 rounded-full bg-indigo-400/10 flex items-center justify-center mb-6 border border-indigo-400/30 group-hover/card:scale-110 transition-transform">
                           <span className="text-5xl">🥈</span>
                        </div>
                        <span className="text-white font-bold uppercase tracking-wider mb-2 text-lg">2nd Prize</span>
                        <span className="text-indigo-300 font-mono text-2xl font-black mb-4">2,500 BDT</span>
                        <span className="text-sm text-indigo-200 bg-white/5 px-4 py-2 rounded-full">Crest + Certificate</span>
                     </div>
                     
                     {/* 1st Prize */}
                     <div className="w-full md:w-80 p-10 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 border border-amber-400/50 shadow-[0_0_50px_rgba(251,191,36,0.15)] hover:shadow-[0_0_80px_rgba(251,191,36,0.3)] hover:-translate-y-8 transition-all duration-500 flex flex-col items-center group/card cursor-pointer relative z-20 md:-mb-8">
                        <div className="absolute -top-6 bg-amber-400 text-slate-900 text-xs font-black uppercase tracking-widest px-6 py-2 rounded-full shadow-[0_0_20px_rgba(251,191,36,0.5)]">Grand Champion</div>
                        <div className="w-28 h-28 rounded-full bg-amber-400/10 flex items-center justify-center mb-6 border border-amber-400/50 group-hover/card:scale-110 transition-transform shadow-[0_0_30px_rgba(251,191,36,0.3)]">
                           <span className="text-7xl drop-shadow-lg">🥇</span>
                        </div>
                        <span className="text-white font-black uppercase tracking-widest mb-2 text-2xl">1st Prize</span>
                        <span className="text-amber-400 font-mono font-black text-4xl mb-6 drop-shadow-[0_0_10px_rgba(251,191,36,0.5)]">3,500 BDT</span>
                        <span className="text-sm text-indigo-100 bg-white/10 px-6 py-3 rounded-full font-medium">Crest + Certificate</span>
                     </div>
                     
                     {/* 3rd Prize */}
                     <div className="w-full md:w-64 p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-fuchsia-400/50 hover:-translate-y-4 transition-all duration-500 flex flex-col items-center group/card cursor-pointer">
                        <div className="w-20 h-20 rounded-full bg-fuchsia-400/10 flex items-center justify-center mb-6 border border-fuchsia-400/30 group-hover/card:scale-110 transition-transform">
                           <span className="text-5xl">🥉</span>
                        </div>
                        <span className="text-white font-bold uppercase tracking-wider mb-2 text-lg">3rd Prize</span>
                        <span className="text-fuchsia-300 font-mono text-2xl font-black mb-4">1,500 BDT</span>
                        <span className="text-sm text-indigo-200 bg-white/5 px-4 py-2 rounded-full">Crest + Certificate</span>
                     </div>
                  </div>
               </div>
      ...
      <section className="py-32 px-6 relative bg-white overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-20 reveal-up-l">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
               {/* Top Winners */}
               <div className="reveal-up-l p-10 rounded-[2.5rem] bg-slate-50 border border-slate-200 hover:border-amber-300 hover:shadow-xl transition-all duration-500">
               ...
               {/* Best Ambassadors */}
               <div className="reveal-up-l p-10 rounded-[2.5rem] bg-slate-50 border border-slate-200 hover:border-indigo-300 hover:shadow-xl transition-all duration-500">
                  <div className="flex items-center gap-4 mb-10">
      ...
      {/* TIMELINE */}
      <section className="py-32 px-6 mission-timeline-l relative bg-[#f8faff] overflow-hidden">
         <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-fuchsia-300 to-transparent" />
         
         <div className="max-w-6xl mx-auto relative">
            <div className="text-center mb-24 reveal-up-l">
            ...
            <div className="space-y-24 relative z-10">
               {[
                  ...
                  <div key={i} className={`reveal-up-l flex flex-col md:flex-row items-center gap-8 md:gap-16 ${i % 2 !== 0 ? 'md:flex-row-reverse' : ''} group`}>

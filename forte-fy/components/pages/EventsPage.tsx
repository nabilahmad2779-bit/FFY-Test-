...
export const EventsPage: React.FC<EventsPageProps> = ({ isDark, navigate }) => {
  ...
  if (selectedEventId === 'mosaic-stories') return <MosaicStories isDark={isDark} onBack={() => setSelectedEventId(null)} />;
  if (selectedEventId === 'spiritual-quest') return <SpiritualQuest isDark={isDark} onBack={() => setSelectedEventId(null)} />;
  if (selectedEventId === 'cosmic-quest') return <CosmicQuest isDark={isDark} onBack={() => setSelectedEventId(null)} />;
  if (selectedEventId === 'brush-flash') return <BrushFlash isDark={isDark} onBack={() => setSelectedEventId(null)} />;

...
export const BrushFlash: React.FC<EventPageProps> = ({ isDark }) => {
         ...
         <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
               {[
                  ...
                  <div key={i} className={`flex items-center gap-5 ${isDark ? 'bg-[#111]' : 'bg-white'} p-5 rounded-3xl border ${isDark ? 'border-white/5' : 'border-black/5'} transition-all hover:bg-[#151515] hover:border-white/20 shadow-lg`}>
                     ...
                     <div className="text-left">
                        <h4 className={`text-lg font-black ${isDark ? 'text-white' : 'text-black'} uppercase mb-0.5`}>{leader.name}</h4>

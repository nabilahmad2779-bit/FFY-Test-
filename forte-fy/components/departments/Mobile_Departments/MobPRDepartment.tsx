    ...
    <div ref={containerRef} className="min-h-screen bg-[#050002] text-white selection:bg-[#DC143C] selection:text-white pb-24 overflow-x-hidden font-sans">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
         <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-100">
            ...
            {/* UPDATED PULSE EFFECT - Very Gradual & Continuous */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-center pointer-events-none">
                <div className="absolute w-[40vw] h-[40vw] bg-[#DC143C] rounded-full blur-[80px] animate-deep-pulse" style={{ animationDelay: '0s' }} />
                <div className="absolute w-[40vw] h-[40vw] bg-[#DC143C] rounded-full blur-[80px] animate-deep-pulse" style={{ animationDelay: '1.5s' }} />
                <div className="absolute w-[40vw] h-[40vw] bg-[#DC143C] rounded-full blur-[80px] animate-deep-pulse" style={{ animationDelay: '3s' }} />
            </div>
         </div>
      ...
      <style>{`
        ...
        @keyframes deep-pulse {
            ...
            50% { opacity: 0.4; } /* Smoother, lower peak for continuous feel */
            100% { transform: scale(2.2); opacity: 0; }
        }
        .animate-deep-pulse { animation: deep-pulse 4.5s cubic-bezier(0.4, 0, 0.2, 1) infinite; }
      `}</style>
    </div>
  );
};

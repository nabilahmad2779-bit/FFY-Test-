    ...
    <div ref={containerRef} className="min-h-screen bg-[#fff0f2] text-slate-900 selection:bg-rose-500 selection:text-white pb-24 overflow-x-hidden font-sans">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
         <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-100">
            ...
            {/* NEW INTENSE PULSE EFFECT (LIGHT) - Refined for Gradual Increase */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex items-center justify-center pointer-events-none">
                <div className="absolute w-[40vw] h-[40vw] bg-rose-500 rounded-full blur-[80px] animate-deep-pulse" style={{ animationDelay: '0s' }} />
                <div className="absolute w-[40vw] h-[40vw] bg-rose-500 rounded-full blur-[80px] animate-deep-pulse" style={{ animationDelay: '1.5s' }} />
                <div className="absolute w-[40vw] h-[40vw] bg-rose-500 rounded-full blur-[80px] animate-deep-pulse" style={{ animationDelay: '3s' }} />
            </div>
         </div>

    ...
    <>
      ...
      >
        ...
        <div className={`relative bg-gradient-to-b ${theme.contentGradient} transition-colors duration-700`}>
          ...
          <section className={`py-24 md:py-40 px-6 relative overflow-hidden ${isDark ? 'bg-black/20 border-white/5' : 'bg-purple-50/30 border-purple-100'} border-t`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                    <div className="lg:col-span-5 reveal-text">
                        <div className={`p-8 md:p-12 rounded-[2.5rem] ${isDark ? 'bg-white/[0.03] border-white/10' : 'bg-white border-purple-100'} border shadow-2xl relative overflow-hidden group`}>
                            ...
                            <h3 className={`text-3xl md:text-4xl font-heading font-black uppercase italic mb-8 relative z-10 ${isDark ? 'text-white' : 'text-slate-900'}`}>
                            ...
                            <div className="mt-12 pt-8 border-t border-white/10 flex items-center justify-between relative z-10">
                                <div className="flex items-center gap-2">
                                   ...
                                   <span className={`text-xs font-bold uppercase tracking-widest ${isDark ? 'text-zinc-400' : 'text-slate-500'}`}>Time Commitment: Flexible</span>
                                </div>
                    ...
                    <div className="lg:col-span-7" id="qualities-list">
                        <h3 className={`text-2xl md:text-3xl font-heading font-bold uppercase tracking-tight ${isDark ? 'text-white' : 'text-slate-900'} mb-10 flex items-center gap-4`}>
                        ...
                        <div className="space-y-4">
                           {QUALITIES.map((quality, idx) => (
                              <div key={idx} className={`quality-item group flex items-start gap-5 p-6 rounded-2xl ${isDark ? 'bg-white/[0.02] border-white/5 hover:bg-white/[0.05]' : 'bg-white border-purple-100 hover:bg-purple-50'} border hover:border-[#bf00ff]/30 transition-all duration-300`}>
                                 ...
                                 <p className={`text-base md:text-lg ${theme.quoteText} font-light leading-snug ${isDark ? 'group-hover:text-white' : 'group-hover:text-slate-900'} transition-colors`}>
                                    {quality}
                                 </p>
                              </div>
                           ))}

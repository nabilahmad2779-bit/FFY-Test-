...
export const PanelPageMobileLight: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#FDFCF8] text-[#1A1A1A] overflow-x-hidden relative pb-24">
      {/* Dynamic Background */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[10%] left-[-20%] w-[250px] h-[250px] rounded-full blur-[80px] opacity-20 bg-[#B8860B] animate-pulse" style={{ animationDuration: '6s' }} />
        <div className="absolute bottom-[30%] right-[-20%] w-[300px] h-[300px] rounded-full blur-[100px] opacity-10 bg-black animate-pulse" style={{ animationDuration: '10s', animationDelay: '1s' }} />
      </div>
      ...
      <section className="min-h-[80vh] w-full flex flex-col items-center justify-center px-6 pt-24 pb-12 text-center relative z-10">
         <div className="absolute inset-0 z-0 overflow-hidden">
           ...
           />
           <div className="absolute inset-0 bg-gradient-to-b from-[#FDFCF8]/90 via-[#FDFCF8]/70 to-[#FDFCF8]" />
         </div>
         ...
         <div className="relative z-10 w-full">
           ...
           <h1 className="mobile-hero-title font-cormorant font-bold italic text-5xl leading-[1.1] tracking-widest text-[#B8860B]">
             BODY
           </h1>
           
           <div className="mobile-hero-subtitle mt-8">
              <div className="w-12 h-px bg-[#B8860B] mx-auto mb-6 opacity-50" />
              <p className="font-outfit text-xs uppercase tracking-[0.3em] text-zinc-600 leading-relaxed font-medium px-4">
      ...
      <section className="w-full px-4 py-12 flex flex-col gap-20 relative z-10">
        {MEMBERS.map((member, index) => (
          <div key={index} className="mobile-member-card flex flex-col w-full">
            ...
            {/* Text Content */}
            <div className="mobile-member-content bg-white border border-black/5 rounded-3xl p-6 pt-10 relative z-10 mx-4 shadow-xl backdrop-blur-md">
               <p className="font-outfit uppercase tracking-[0.2em] text-[#B8860B] text-[10px] mb-3 font-medium text-center">
                 {member.role}
               </p>
               <h2 className="font-cormorant font-bold text-3xl mb-4 leading-tight text-center">
                 {member.name}
               </h2>
               <p className="font-outfit font-light text-zinc-600 leading-relaxed text-sm text-center">
                 {member.bio}
               </p>
            </div>
      ...
      <section className="py-20 w-full flex items-center justify-center relative z-10">
         <div className="w-px h-16 bg-[#B8860B] opacity-30" />
      </section>

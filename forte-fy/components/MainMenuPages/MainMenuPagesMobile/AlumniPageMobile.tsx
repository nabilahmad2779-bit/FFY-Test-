...
import { AlumniPageMobileLight } from './MobileMenuLight/AlumniPageMobileLight.tsx';

export const AlumniPageMobile: React.FC<{ isDark: boolean }> = ({ isDark }) => {
  if (!isDark) {
    return <AlumniPageMobileLight />;
  }
  ...
  return (
    <div className="pb-24 pt-24 px-6 min-h-screen bg-black text-white animate-fade-in">
      ...
      <div className="p-8 rounded-3xl border bg-white/5 border-white/10">

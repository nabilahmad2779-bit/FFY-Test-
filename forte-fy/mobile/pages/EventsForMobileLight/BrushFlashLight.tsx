...
export const BrushFlashMobile_light: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  const isDark = false;
  ...
  return (
    <div
      ref={containerRef}
      className={`min-h-screen ${'bg-[#f8f8f8] text-[#1a1a1a]'} overflow-x-hidden selection:bg-[#ff007f] selection:text-white font-sans transition-colors duration-500 [&::-webkit-scrollbar]:hidden`}
    >

      {/* ════════════════════════════════════════
          1. HERO — identical markup to PC
      ════════════════════════════════════════ */}
      <section className={`hero-section h-screen w-full relative flex items-center justify-center overflow-hidden ${'bg-white'}`}>
        {/* Glowing Background Orb */}
        <div className={`hero-bg-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-gradient-to-tr from-[#ff007f]/30 ${'via-[#008b8b]/20'} to-[#f4d03f]/30 rounded-full blur-[80px] pointer-events-none`} />
        ...
        <div className="hero-bg-img absolute inset-0 z-0">
          ...
          />
          <div className={`absolute inset-0 bg-gradient-to-b ${'from-black/60 via-transparent to-[#f8f8f8]'}`} />
        </div>

        {/* Split Typography — same class names as PC so GSAP targets identically */}
        <h1 className={`brush-text absolute z-30 text-[22vw] font-black tracking-tighter ${'text-[#ff007f]'} pointer-events-none leading-none drop-shadow-[0_0_20px_rgba(244,208,63,0.8)]`}>
          BRUSH
        </h1>
        <h1 className={`flash-text absolute z-30 text-[22vw] font-black tracking-tighter text-transparent ${'[-webkit-text-stroke:2px_#1a1a1a]'} pointer-events-none leading-none drop-shadow-[0_0_20px_rgba(255,0,127,0.8)]`}>
          &amp; FLASH
        </h1>
      ...
      <section
        ...
        className={`intro-section py-24 px-6 ${'bg-[#f0f0f0]'} relative z-10 overflow-hidden min-h-[80vh] flex flex-col justify-center`}
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className={`story-float absolute bottom-[15%] right-[10%] w-48 h-48 ${'bg-[#008b8b]/10'} rounded-full blur-3xl`} />
        </div>
        ...
        <div className="max-w-lg mx-auto relative z-10 w-full">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className={`text-xs font-black uppercase tracking-[0.5em] ${'text-black/40'}`}>The Narrative</h2>
          </div>

          <div className="flex flex-col gap-10">
            {/* Text-fill headline — Interactive Scroll Gradient */}
            <h2 className={`text-3xl font-black leading-[1.1] tracking-tighter uppercase text-center ${'text-zinc-400'}`}>
              <span className={`interactive-text-span bg-clip-text text-transparent ${'bg-[linear-gradient(to_right,#1a1a1a_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>A celebration of </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${'bg-[linear-gradient(to_right,#ff007f_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>raw talent </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${'bg-[linear-gradient(to_right,#1a1a1a_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>and </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${'bg-[linear-gradient(to_right,#008b8b_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>boundless </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${'bg-[linear-gradient(to_right,#f4d03f_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>creativity.</span>
            </h2>

            <div className="story-content space-y-6 text-center">
              <p className={`story-line text-base font-light leading-relaxed ${'text-zinc-600'}`}>
                <span className={`${'text-black'} font-bold`}>Brush &amp; Flash</span> was born from a simple idea: bringing together the <span className="text-[#ff007f] italic font-medium">raw feel</span> of traditional art and the <span className={`${'text-[#008b8b]'} italic font-medium`}>endless possibilities</span> of digital creativity. We wanted to create a welcoming space where young artists and photographers could just be themselves, share their work, and <span className="text-[#f4d03f] italic font-medium">grow together</span>.
              </p>
              <p className={`story-line text-base font-light leading-relaxed ${'text-zinc-600'}`}>
                It wasn't just about hosting an exhibition; it was about <span className={`${'text-black'} font-bold`}>building a real community</span>. Every sketch, every digital stroke, and every snapped photo tells a <span className={`${'text-black'} italic underline decoration-[#ff007f]/50 underline-offset-8 decoration-2`}>unique story</span>. We're incredibly proud of the amazing talent we've seen and the genuine connections made along the way.
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ...
        className={`metrics-section py-32 px-6 ${'bg-white'} relative z-10 border-t ${'border-black/10'} overflow-hidden`}
      >
        ...
        <div className="max-w-lg mx-auto text-center relative z-10">
          <div className="mb-16">
            ...
            <h2 className={`text-sm font-black uppercase tracking-[0.4em] ${'text-black/40'}`}>Performance Metrics</h2>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              { val: event.metrics.ambassadors,   label: "Curators",           color: "text-[#008b8b]" },
            ].map((stat, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`metric-item flex flex-col items-center justify-center ${'bg-[#f0f0f0]'} p-4 rounded-2xl border ${'border-black/5'} shadow-lg`}
                >
                  ...
                  <p className={`text-[8px] font-black uppercase tracking-widest ${'text-black/60'}`}>{stat.label}</p>
                </div>
              );
            })}
          </div>
      ...
      ════════════════════════════════════════ */}
      <section
        className={`disciplines-section h-[100dvh] w-full overflow-hidden ${'bg-white'} relative z-10 border-t ${'border-black/10'}`}
      >
        {/* Section header */}
        <div className={`absolute top-8 left-6 z-50 ${'text-black'} mix-blend-difference pointer-events-none`}>
            ...
            >
              ...
              <div className={`flex flex-col items-center justify-center w-full max-w-sm gap-6 z-10 ${idx % 2 !== 0 ? 'flex-col-reverse' : ''}`}>
                ...
                <div className="disc-text w-full text-center relative">
                  ...
                  <p className={`text-sm ${'text-zinc-600'} font-medium leading-relaxed max-w-[90%] mx-auto`}>
                    {disc.description}
                  </p>
                </div>
      ...
      <section
        ...
        className={`py-24 px-6 ${'bg-[#f5f5f5]'} relative z-10 border-t ${'border-black/10'}`}
      >
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-14">
            <span className={`${'text-[#008b8b]'} text-[10px] font-black uppercase tracking-[0.6em] mb-4 block`}>Section V</span>
            ...
            <p className={`${'text-zinc-400'} text-xs font-bold uppercase tracking-[0.5em] mt-3`}>Recognizing Excellence</p>
          </div>

          {/* Tab switcher */}
          <div className={`${'bg-white'} rounded-[2rem] p-4 border ${'border-black/5'} shadow-2xl mb-10`}>
            ...
            <div className="space-y-3 min-h-[260px]">
              {WINNERS[activeCategory].winners.map((winner, i) => (
                <div
                  key={i}
                  className={`flex items-center gap-4 p-4 rounded-2xl ${'bg-[#f8f8f8]'} border ${'border-black/5'}`}
                >
          ...
          <div className="grid grid-cols-1 gap-5">
            {[
              { name: "Tasnim Mahi",        role: "Best Campus Ambassador", img: "https://i.postimg.cc/MpCtwTRz/485146929-652411014185940-2123160853129889170-n-(1).jpg", color: "#008b8b" },
              { name: "Durrah Mehnaz Arshi", role: "Best Coordinator",       img: "https://i.postimg.cc/gkwTb1Qd/1000206343.jpg", color: "#ff007f" },
            ].map((leader, i) => (
              <div
                key={i}
                className={`flex items-center gap-5 ${'bg-white'} p-6 rounded-[2rem] border ${'border-black/5'} shadow-2xl relative overflow-hidden group`}
              >
                ...
                <div className="text-left relative z-10">
                  <h4 className={`text-lg font-black ${'text-black'} uppercase mb-1 tracking-tight`}>{leader.name}</h4>
      ...
      <section
        id="curated-archive"
        className={`py-28 px-6 ${'bg-white'} relative z-10 border-t ${'border-black/10'}`}
      >
        <div className="max-w-lg mx-auto">
          <div className="mb-16 flex flex-col items-center text-center">
            <span className={`${'text-[#008b8b]'} text-[10px] font-black uppercase tracking-[0.6em] mb-4 block`}>Section VI</span>
            <h2 className={`text-4xl font-black tracking-tighter ${'text-black'} uppercase`}>
              Curated <span className="text-[#ff007f]">Archive</span>
            </h2>
            <p className={`${'text-[#008b8b]'} text-xs font-bold uppercase tracking-widest mt-4`}>Scroll to reveal</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-5">
            {[1, 2, 3, 4, 5, 6].map((item, i) => (
              ...
              >
                <div className={`w-full aspect-[3/4] overflow-hidden rounded-3xl border ${'border-black/10'} shadow-2xl relative`}>
                  <img
      ...
      <footer
        ...
        className={`py-28 px-6 ${'bg-[#f8f8f8]'} relative z-10 border-t ${'border-black/10'}`}
      >
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#f4d03f] text-[10px] font-black uppercase tracking-[0.6em] mb-4 block">Section VII</span>
            <h2 className={`text-xs font-black uppercase tracking-[0.4em] ${'text-black/40'}`}>Institutional Synergy</h2>
          </div>

          {/* Strategic sponsors */}
          <div className="mb-20">
            <h3 className={`text-center text-xs font-black uppercase tracking-[0.4em] ${'text-black/40'} mb-12`}>Strategic Sponsors</h3>
          ...
          <h3 className={`text-center text-xs font-black uppercase tracking-[0.4em] ${'text-black/40'} mb-12`}>Institutional Partners</h3>

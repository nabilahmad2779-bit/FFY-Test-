...
export const BrushFlashMobile: React.FC<EventPageProps> = ({ isDark, onBack }) => {
  ...
  const DISCIPLINES = [
    ...
    },
    {
      ...
      accent: isDark ? 'rgba(0,255,255,0.2)' : 'rgba(0,139,139,0.2)',
      aspect: 'aspect-square',
    },
    {
      id: 'photography',
  ...
  return (
    <div
      ref={containerRef}
      className={`min-h-screen ${isDark ? 'bg-[#050505] text-[#e5e5e5]' : 'bg-[#f8f8f8] text-[#1a1a1a]'} overflow-x-hidden selection:bg-[#ff007f] selection:text-white font-sans transition-colors duration-500 [&::-webkit-scrollbar]:hidden`}
    >
      ...
      <section className={`hero-section h-screen w-full relative flex items-center justify-center overflow-hidden ${isDark ? 'bg-[#050505]' : 'bg-white'}`}>
        ...
        <div className={`hero-bg-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-gradient-to-tr from-[#ff007f]/30 ${isDark ? 'via-[#00ffff]/20' : 'via-[#008b8b]/20'} to-[#f4d03f]/30 rounded-full blur-[80px] pointer-events-none`} />
        ...
        <div className="hero-bg-img absolute inset-0 z-0">
          ...
          />
          <div className={`absolute inset-0 bg-gradient-to-b ${isDark ? 'from-[#050505]/80 via-transparent to-[#050505]' : 'from-black/60 via-transparent to-[#f8f8f8]'}`} />
        </div>

        {/* Split Typography — same class names as PC so GSAP targets identically */}
        <h1 className={`brush-text absolute z-30 text-[22vw] font-black tracking-tighter ${isDark ? 'text-[#f4d03f] mix-blend-screen' : 'text-[#ff007f]'} pointer-events-none leading-none drop-shadow-[0_0_20px_rgba(244,208,63,0.8)]`}>
          BRUSH
        </h1>
        <h1 className={`flash-text absolute z-30 text-[22vw] font-black tracking-tighter text-transparent ${isDark ? '[-webkit-text-stroke:2px_#ff007f] mix-blend-screen' : '[-webkit-text-stroke:2px_#1a1a1a]'} pointer-events-none leading-none drop-shadow-[0_0_20px_rgba(255,0,127,0.8)]`}>
          &amp; FLASH
        </h1>
      ...
      <section
        ...
        className={`intro-section py-24 px-6 ${isDark ? 'bg-[#080808]' : 'bg-[#f0f0f0]'} relative z-10 overflow-hidden min-h-[80vh] flex flex-col justify-center`}
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className={`story-float absolute bottom-[15%] right-[10%] w-48 h-48 ${isDark ? 'bg-[#00ffff]/10' : 'bg-[#008b8b]/10'} rounded-full blur-3xl`} />
        </div>
        ...
        <div className="max-w-lg mx-auto relative z-10 w-full">
          ...
          <div className="flex flex-col gap-10">
            ...
            <h2 className={`text-3xl font-black leading-[1.1] tracking-tighter uppercase text-center ${isDark ? 'text-zinc-800' : 'text-zinc-400'}`}>
              <span className={`interactive-text-span bg-clip-text text-transparent ${isDark ? 'bg-[linear-gradient(to_right,#ffffff_50%,#333333_50%)]' : 'bg-[linear-gradient(to_right,#1a1a1a_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>A celebration of </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${isDark ? 'bg-[linear-gradient(to_right,#ff007f_50%,#333333_50%)]' : 'bg-[linear-gradient(to_right,#ff007f_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>raw talent </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${isDark ? 'bg-[linear-gradient(to_right,#ffffff_50%,#333333_50%)]' : 'bg-[linear-gradient(to_right,#1a1a1a_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>and </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${isDark ? 'bg-[linear-gradient(to_right,#00ffff_50%,#333333_50%)]' : 'bg-[linear-gradient(to_right,#008b8b_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>boundless </span>
              <span className={`interactive-text-span bg-clip-text text-transparent ${isDark ? 'bg-[linear-gradient(to_right,#f4d03f_50%,#333333_50%)]' : 'bg-[linear-gradient(to_right,#f4d03f_50%,#999999_50%)]'} bg-[length:200%_100%] bg-[position:100%_0]`}>creativity.</span>
            </h2>

            <div className="story-content space-y-6 text-center">
              <p className={`story-line text-base font-light leading-relaxed ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>
                <span className={`${isDark ? 'text-white' : 'text-black'} font-bold`}>Brush &amp; Flash</span> was born from a simple idea: bringing together the <span className="text-[#ff007f] italic font-medium">raw feel</span> of traditional art and the <span className={`${isDark ? 'text-[#00ffff]' : 'text-[#008b8b]'} italic font-medium`}>endless possibilities</span> of digital creativity. We wanted to create a welcoming space where young artists and photographers could just be themselves, share their work, and <span className="text-[#f4d03f] italic font-medium">grow together</span>.
              </p>
              <p className={`story-line text-base font-light leading-relaxed ${isDark ? 'text-zinc-400' : 'text-zinc-600'}`}>
      ...
      <section
        ...
        className={`metrics-section py-32 px-6 ${isDark ? 'bg-[#050505]' : 'bg-white'} relative z-10 border-t ${isDark ? 'border-white/10' : 'border-black/10'} overflow-hidden`}
      >
        ...
        <div className="max-w-lg mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              { val: event.metrics.ambassadors,   label: "Curators",           color: isDark ? "text-[#00ffff]" : "text-[#008b8b]" },
            ].map((stat, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`metric-item flex flex-col items-center justify-center ${isDark ? 'bg-[#111]' : 'bg-[#f0f0f0]'} p-4 rounded-2xl border ${isDark ? 'border-white/5' : 'border-black/5'} shadow-lg`}
                >
                  ...
                  <p className={`text-[8px] font-black uppercase tracking-widest ${isDark ? 'text-white/60' : 'text-black/60'}`}>{stat.label}</p>
                </div>
              );
            })}
          </div>
      ...
      ════════════════════════════════════════ */}
      <section
        className={`disciplines-section h-[100dvh] w-full overflow-hidden ${isDark ? 'bg-[#050505]' : 'bg-white'} relative z-10 border-t ${isDark ? 'border-white/10' : 'border-black/10'}`}
      >
        {/* Section header */}
        <div className={`absolute top-8 left-6 z-50 ${isDark ? 'text-white' : 'text-black'} mix-blend-difference pointer-events-none`}>
            ...
            >
              ...
              <div className={`flex flex-col items-center justify-center w-full max-w-sm gap-6 z-10 ${idx % 2 !== 0 ? 'flex-col-reverse' : ''}`}>
                ...
                <div className="disc-text w-full text-center relative">
                  ...
                  <p className={`text-sm ${isDark ? 'text-zinc-300' : 'text-zinc-600'} font-medium leading-relaxed max-w-[90%] mx-auto`}>
                    {disc.description}
                  </p>
                </div>
                ...
                >
                  ...
                  />
                  {/* Gradient Overlay */}
                  <div className={`absolute inset-0 bg-gradient-to-t ${isDark ? 'from-black/80 via-black/20' : 'from-black/60 via-transparent'} to-transparent`} />
      ...
      <section
        ...
        className={`py-24 px-6 ${isDark ? 'bg-[#0a0a0a]' : 'bg-[#f5f5f5]'} relative z-10 border-t ${isDark ? 'border-white/10' : 'border-black/10'}`}
      >
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-14">
            <span className={`${isDark ? 'text-[#00ffff]' : 'text-[#008b8b]'} text-[10px] font-black uppercase tracking-[0.6em] mb-4 block`}>Section V</span>
            <h2 className={`text-4xl font-black tracking-tighter ${isDark ? 'text-white' : 'text-black'} uppercase italic`}>
              The <span className="text-[#ff007f]">Apex</span> Circle
            </h2>
            <p className={`${isDark ? 'text-zinc-500' : 'text-zinc-400'} text-xs font-bold uppercase tracking-[0.5em] mt-3`}>Recognizing Excellence</p>
          </div>

          {/* Tab switcher */}
          <div className={`${isDark ? 'bg-[#111]' : 'bg-white'} rounded-[2rem] p-4 border ${isDark ? 'border-white/5' : 'border-black/5'} shadow-2xl mb-10`}>
            ...
            <div className="space-y-3 min-h-[260px]">
              {WINNERS[activeCategory].winners.map((winner, i) => (
                <div
                  key={i}
                  className={`flex items-center gap-4 p-4 rounded-2xl ${isDark ? 'bg-black/50' : 'bg-[#f8f8f8]'} border ${isDark ? 'border-white/5' : 'border-black/5'}`}
                >
          ...
          <div className="grid grid-cols-1 gap-5">
            {[
              { name: "Tasnim Mahi",        role: "Best Campus Ambassador", img: "https://i.postimg.cc/MpCtwTRz/485146929-652411014185940-2123160853129889170-n-(1).jpg", color: isDark ? "#00ffff" : "#008b8b" },
              { name: "Durrah Mehnaz Arshi", role: "Best Coordinator",       img: "https://i.postimg.cc/gkwTb1Qd/1000206343.jpg", color: "#ff007f" },
            ].map((leader, i) => (
              <div
                key={i}
                className={`flex items-center gap-5 ${isDark ? 'bg-zinc-900/40 backdrop-blur-md' : 'bg-white'} p-6 rounded-[2rem] border ${isDark ? 'border-white/10' : 'border-black/5'} shadow-2xl relative overflow-hidden group`}
              >
      ...
      <section
        id="curated-archive"
        className={`py-28 px-6 ${isDark ? 'bg-[#111111]' : 'bg-white'} relative z-10 border-t ${isDark ? 'border-white/10' : 'border-black/10'}`}
      >
        <div className="max-w-lg mx-auto">
          <div className="mb-16 flex flex-col items-center text-center">
            <span className={`${isDark ? 'text-[#00ffff]' : 'text-[#008b8b]'} text-[10px] font-black uppercase tracking-[0.6em] mb-4 block`}>Section VI</span>
            <h2 className={`text-4xl font-black tracking-tighter ${isDark ? 'text-white' : 'text-black'} uppercase`}>
              Curated <span className="text-[#ff007f]">Archive</span>
            </h2>
            <p className={`${isDark ? 'text-[#00ffff]' : 'text-[#008b8b]'} text-xs font-bold uppercase tracking-widest mt-4`}>Scroll to reveal</p>
          </div>
      ...
      <footer
        ...
        className={`py-28 px-6 ${isDark ? 'bg-[#050505]' : 'bg-[#f8f8f8]'} relative z-10 border-t ${isDark ? 'border-white/10' : 'border-black/10'}`}
      >
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-16">
            <span className="text-[#f4d03f] text-[10px] font-black uppercase tracking-[0.6em] mb-4 block">Section VII</span>
            <h2 className={`text-xs font-black uppercase tracking-[0.4em] ${isDark ? 'text-white/40' : 'text-black/40'}`}>Institutional Synergy</h2>
          </div>

          {/* Strategic sponsors */}
          <div className="mb-20">
            <h3 className={`text-center text-xs font-black uppercase tracking-[0.4em] ${isDark ? 'text-white/40' : 'text-black/40'} mb-12`}>Strategic Sponsors</h3>
          ...
          <h3 className={`text-center text-xs font-black uppercase tracking-[0.4em] ${isDark ? 'text-white/40' : 'text-black/40'} mb-12`}>Institutional Partners</h3>
